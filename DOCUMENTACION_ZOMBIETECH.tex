...
|-- Shaders/CheckerboardKeySprite.shader
`-- Settings/
\end{lstlisting}
...
La acción solo se permite cuando el personaje está en el suelo y quieto. En el avance actual el disparo es visual: todavía no crea un proyectil ni causa daño.
...
$\square$ & Pulsar \keycap{F} estando quieto & Reproduce una vez los seis frames de disparo sin mostrar el tablero de fondo. \\
\bottomrule
\end{tabularx}
...
Interacción principal & Plataformas atravesables; el combate todavía no aplica daño & Parcial \\
Prefabs & Aún no existe un prefab reutilizable & Pendiente \\
...
Crear al menos un prefab reutilizable, implementar una interacción verificable como una bala que daña a un zombi o un objeto coleccionable, agregar reinicio y comprobar que la consola permanezca sin errores durante la demostración.
\end{warningbox}
