...
Interacción principal & El zombi persigue, ataca y provoca la muerte animada del jugador & Implementado \\
...
Implementar una interacción verificable como una bala que daña al zombi o un objeto coleccionable, agregar reinicio y comprobar que la consola permanezca sin errores durante la demostración.
\end{warningbox}
...
\begin{enumerate}
  \item Crear proyectiles para que el disparo pueda dañar al zombi.
  \item Implementar puntos de salud, daño gradual y muerte del enemigo.
...
El prototipo ya posee escenario, personaje animado, movimiento, salto, colisiones, plataformas, música y un zombi cabezón creado como Prefab. El enemigo persigue, reproduce su ataque y activa la muerte animada del jugador. El siguiente gran paso recomendado es implementar proyectiles, salud del enemigo y reinicio.
\end{gamebox}
