...
Inicio y reinicio & Inicia con Play y la pantalla Game Over permite reintentar & Implementado \\
...
La interacción mediante proyectiles, daño y reinicio ya está implementada. Las siguientes prioridades son grabar el video, agregar una interfaz de vida y comprobar que la consola permanezca sin errores durante la demostración.
\end{warningbox}
...
El prototipo ya posee escenario, personaje animado, movimiento, salto, colisiones, plataformas, música, combate, reinicio y un zombi cabezón creado como Prefab. El enemigo persigue y ataca al jugador; el personaje dispara proyectiles animados que causan daño y eliminan al zombi después de tres impactos. El siguiente gran paso recomendado es preparar el video de demostración y una interfaz de vida.
\end{gamebox}
